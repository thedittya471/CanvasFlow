...
export function NetworkSection({ isLoggedIn }: { isLoggedIn: boolean }) {
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-[1320px] px-4 sm:px-6 md:px-8 py-28 lg:py-36 text-center">
        <p className="cf-eyebrow text-[color:var(--cf-ink-soft)]">A growing studio</p>
        <h2 className="mx-auto mt-6 cf-display text-[44px] sm:text-[64px] md:text-[76px] leading-[0.96] max-w-3xl">
          Every form makes
          <span className="block">the studio stronger</span>
        </h2>
        <p className="mx-auto mt-6 max-w-xl text-[15px] leading-relaxed text-[color:var(--cf-ink-soft)]">
